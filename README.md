# Dataset for Persian old Cuneiform
...
Ciphering Persian Old language has some steps, for example, transliteration and transcription. Below you can see an example to know the difference between them:
